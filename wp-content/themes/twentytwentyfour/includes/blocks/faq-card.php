...
class FAQ_Post_Card extends Skeletor_Block { 
    public static $title = 'FAQ post card';
    public static $name = 'faq_post_card';
...
add_action('after_setup_theme', ['FAQ_Post_Card', 'init']);