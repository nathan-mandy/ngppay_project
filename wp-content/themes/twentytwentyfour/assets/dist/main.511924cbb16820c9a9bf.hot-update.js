...
function checkScreenWidth() {
  ...
  if (window.innerWidth < 1025) {
    ...
    document.querySelector('.header-row').append(document.querySelector('.nav-row nav ul'));
    document.querySelector('.header-row').append(document.querySelector('.header-button-design'));
  }
}
checkScreenWidth();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("aff4dad40cf387d51aa1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.511924cbb16820c9a9bf.hot-update.js.map