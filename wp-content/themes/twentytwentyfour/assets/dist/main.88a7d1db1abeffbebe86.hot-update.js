...
minusPlusIcons.forEach(function (icon) {
  icon.addEventListener("click", function (event) {
    ...
    minusPlusIcons.forEach(function (otherIcon) {
      if (otherIcon !== icon) {
        otherIcon.classList.remove("show-icon");
        otherIcon.classList.add("close-icon");
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1edca1b641dd55726add")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.88a7d1db1abeffbebe86.hot-update.js.map