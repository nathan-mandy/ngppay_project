...
function checkScreenWidth() {
  ...
  if (window.innerWidth < 1025) {
    ...
    document.querySelector('.nav-row').appendChild(document.querySelector('.nav-row nav ul'));
    document.querySelector('.nav-row').appendChild(document.querySelector('.header-button-design'));
  }
}
checkScreenWidth();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("51ee48d8a9b8e48a3641")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.e0cd2223c898f020d091.hot-update.js.map