...
function checkScreenWidth() {
  ...
  // Check if the screen width is 1025px or more
  else {
    const navRow = document.querySelector('.nav-row');
    const navUl = document.querySelector('.nav-row nav ul');
    const headerButton = document.querySelector('.header-button-design');
    if (navRow && navUl && headerButton) {
      navRow.append(navUl); // Append nav ul back to nav-row if necessary
      navRow.append(headerButton); // Append header button to nav-row
    }
  }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("15693f7608083cf40ad8")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.c2e1fc2d70d2fa5e6940.hot-update.js.map